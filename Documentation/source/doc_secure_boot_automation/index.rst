...
.. note::
    ...
    See `meta layer documentation <https://github.com/nxp-imx-support/meta-nxp-security-reference-design/tree/wrynose-6.18.20-2.0.0/meta-secure-boot>`_ for the information on the supported devices and supported distro for this release.
